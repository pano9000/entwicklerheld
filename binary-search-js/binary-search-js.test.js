...
it('test 1 1', () => {
    ...
    expect(actual, `Given an array [ ${arr} ] with one element the element ${element} should be found in step ${expected.step} an return index ${expected.index}.`).to.deep.equal(expected);
});
